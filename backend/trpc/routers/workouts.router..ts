...
export const syncWorkouts = protectedProcedure.input(WorkoutsSchema).query(async ({ input, ctx }) => {
...
export const syncWorkoutExercises = protectedProcedure.input(WorkoutExercisesSchema).query(async ({ input, ctx }) => {
...
export const syncSets = protectedProcedure.input(SetsSchema).query(async ({ input, ctx }) => {
